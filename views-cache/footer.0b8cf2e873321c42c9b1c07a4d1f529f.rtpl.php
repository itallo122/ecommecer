...
<div class="footer-bottom-area">
    ...
    <!-- jQuery sticky menu -->
    <script src="/projeto/res/site/js/owl.carousel.min.js"></script>
    <script src="/projeto/res/site/js/jquery.sticky.js"></script>
    
    <!-- jQuery easing -->
    <script src="/projeto/res/site/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="/projeto/res/site/js/main.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" src="/projeto/res/site/js/bxslider.min.js"></script>
	<script type="text/javascript" src="/projeto/res/site/js/script.slider.js"></script>
  </body>
</html>